...
class dceWeekSpider(Spider):
    name = "dceWeek"  # name是必须的
    defaultHeader = {  # 请求头
    ...
    urlTemplate = 'http://www.dce.com.cn/publicweb/quotesdata/weekQuotesCh.html?weekQuotes.variety=all&weekQuotes.trade_type=0&year=2017&month=11&day=18'
    start_urls = [
        urlTemplate
    ]
